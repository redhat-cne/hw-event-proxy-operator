...
HW_EVENT_PROXY_IMAGE_DIGEST=$(skopeo inspect docker://quay.io/openshift/origin-baremetal-hardware-event-proxy | jq --raw-output '.Digest')
...
export HW_EVENT_PROXY_IMAGE=${HW_EVENT_PROXY_IMAGE:-quay.io/openshift/origin-baremetal-hardware-event-proxy@${HW_EVENT_PROXY_IMAGE_DIGEST}}
